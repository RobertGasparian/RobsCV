...
class NetworkBackedRcvEducationRepository(
    private val remoteDataSource: RcvEducationRemoteDataSource,
    private val educationDao: RcvEducationDao,
) : RcvEducationRepository {
    override val education: Flow<Result<RcvEducation>> = educationDao
        .educationGraphFlow()
        .map { graph ->
            graph
